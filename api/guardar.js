...
export default async function handler(req, res) {
  /* Interruptor del sorteo. Esto es lo que de verdad cierra la puerta: quitar
     el boton del frontend no impide un POST directo a /api/guardar.
     Cierra por defecto — sin la variable definida responde 403. Para abrir el
     proximo sorteo basta con poner SORTEO_ABIERTO=1 en Vercel y redesplegar,
     sin tocar codigo. Mismo patron que MAINTENANCE_MODE en middleware.js.
     Ojo: las variables de entorno se inyectan en BUILD, asi que cambiarla
     exige un redespliegue, no basta con guardarla en el panel. */
  if (process.env.SORTEO_ABIERTO !== '1') {
